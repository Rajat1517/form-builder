            ...
            {builders.length === 0 &&
                <div className={`${styles.emptyDrop}`}>
                    <svg className={`${styles.emptyIcon}`} viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.9062 33.5312L27.8438 33.5313" stroke="#007AD3" stroke-width="2"/>
                    </svg>
